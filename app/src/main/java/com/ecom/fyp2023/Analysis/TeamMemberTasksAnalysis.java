...
public class TeamMemberTasksAnalysis extends AppCompatActivity {
    LineChart lineChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_member_tasks_analysis);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(TeamMemberTasksAnalysis.this, TeamMemberEvaluation.class);
        ...
        CollectionReference userTasks = db.collection("userTasks");
        Query query = userTasks.whereEqualTo("userId", userId);
    ...
    private void updateLineChart(@NonNull List<Tasks> tasksList) {
        ...
        description.setText("Team member task analysis");
